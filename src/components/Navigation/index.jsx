      ...
      >
        ...
        <div className="popup__body">
          <div className="popup__btn-group popup__confirm">
            <button type="button" className="button popup__btn" onClick={() => onLogOut()}> Да </button>
            <button type="button" className="button popup__btn" onClick={() => setShowConfirm(false)}> Отмена </button>
          </div>
        </div>
